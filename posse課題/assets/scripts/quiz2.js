...
function createQuestion(question_id, select_array, question, answer_id){
    let quiz =`<div>`
    +`<span class="q-box-title">Q${question_id}</span>`
    +`<h3>${question}</h3>`
...
function createHtml(){
    createQuestion(1,["約28万人","約79万人","約183万人"],"日本のIT人材が2030年には最大どれくらい不足すると言われているでしょうか？",1)
    createQuestion(2,["INTECH","BIZZTECH","X-TECH"],"既存業界のビジネスと、先進的なテクノロジーを結びつけて生まれた、新しいビジネスのことをなんと言うでしょう？",2)
    createQuestion(3,["Internet of Things","Integrate into Technology","Information on Tool"],"IoTとは何の略でしょう",0)
    createQuestion(4,["Society5.0","CyPhy","SDGs"],"日本が目指すサイバー空間とフィジカル空間を高度に融合させたシステムによって開かれる未来社会のことをなんと言うでしょうか",0)
    createQuestion(5,["web3.0","NFT","メタバース"],"イギリスのコンピューター科学者であるギャビン・ウッド氏が提唱した、ブロックチェーン技術を活用した「次世代分散型インターネット」のことをなんというでしょう？",0)
    createQuestion(6,["約2倍","約5倍","約11倍"],"先進テクノロジー活用企業と出遅れた企業の収益性の差はどれくらいあると言われているでしょうか？",1)
}
createHtml();
